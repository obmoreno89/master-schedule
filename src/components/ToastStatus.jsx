...
function ToastStatus({ children, className, type, open, setOpen }) {
  const typeIcon = (type) => {
    switch (type) {
      case 'warning':
        return (
    ...
    <>
      {open && (
        <div className={className}>
          <div className='inline-flex min-w-80 px-4 py-2 rounded-sm text-sm bg-white shadow-lg border border-slate-200 text-slate-600 font-semibold'>
