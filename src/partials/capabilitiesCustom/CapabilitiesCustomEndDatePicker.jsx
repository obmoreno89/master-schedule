...
function CapabilitiesCustomEndDatePicker({
  align,
  setFinalDate,
  finalDate,
  create,
}) {
  const dateFrom = new Date(finalDate);
  ...
  const options = {
    ...
    dateFormat: "Y-m-d",
    defaultDate: create ? new Date() : finalDate && dateFrom,
...
export default CapabilitiesCustomEndDatePicker;
