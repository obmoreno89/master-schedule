...
import {
  selectCapabilitiesCustomDeleteData,
  capabilitiesCustomDelete,
} from '../../store/slice/capabilitiesCustomSlice';

function ModalCapabilitiesCustomDelete({
  openModalCapabilitiesCustomDelete,
  setOpenModalCapabilitiesCustomDelete,
}) {
  const dispatch = useDispatch();
  const capabilitiesCustomDeleteData = useSelector(
    selectCapabilitiesCustomDeleteData
  );
  ...
  return (
    <ModalBlank
      id='success-modal'
      modalOpen={openModalCapabilitiesCustomDelete}
      SetModalOpen={setOpenModalCapabilitiesCustomDelete}
    >
        ...
        <div>
          ...
          <div className='mb-2 flex justify-between items-center'>
            <div className='text-lg font-bold text-slate-800 w-96'>
              ...
              {capabilitiesCustomDeleteData?.product_line?.name} ?
            </div>
            <button
              onClick={(e) => {
                e.stopPropagation();
                setOpenModalCapabilitiesCustomDelete(false);
              }}
            >
              <svg
          ...
          <div className='flex justify-center items-center'>
            <button
              onClick={(e) => {
                e.stopPropagation();
                dispatch(
                  capabilitiesCustomDelete(capabilitiesCustomDeleteData.id)
                );
                setOpenModalCapabilitiesCustomDelete(false);
              }}
...
export default ModalCapabilitiesCustomDelete;
