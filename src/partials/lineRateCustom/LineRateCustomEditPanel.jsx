...
import LineRateCustomEdit from './LineRateCustomEdit';
import { useDispatch } from 'react-redux';
import { revertEdit } from '../../store/slice/LineRateCustomSlice';

function LineRateCustomEditPanel({
  ...
  useEffect(() => {
    const keyHandler = ({ keyCode }) => {
      if (!LineRateCustomEditOpenPanel || keyCode !== 27) return;
  ...
  return (
    <>
      <Transition
        ...
        show={LineRateCustomEditOpenPanel}
      ...
      >
        <div
          ...
          className={` absolute inset-0 sm:left-auto z-40 transform shadow-xl transition-transform duration-200 ease-in-out ${
            LineRateCustomEditOpenPanel ? 'translate-x-' : 'translate-x-full'
          }`}
        >
...
export default LineRateCustomEditPanel;
