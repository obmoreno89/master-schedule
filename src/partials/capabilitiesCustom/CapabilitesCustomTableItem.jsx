    ...
    <>
      <table className='table-auto w-full table'>
        ...
        <tbody className='text-sm divide-y divide-slate-200'>
          <tr>
            <td className='px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap md:w-1/5 cursor-pointer'>
              <div className='flex items-center space-x-10'>
            ...
            <td className='px-3 first:pl-5 last:pr-5 py-3 whitespace-nowrap cursor-pointer flex space-x-3'>
