                          ...
                          <div className='text-sm'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <p>
                                ...
                                consequat interdum varius sit. Nec sagittis
                                aliquam malesuada bibendum arcu vitae elementum
                                curabitur vitae. Mattis enim ut tellus elementum
                                el fringilla est ullamcorper eget nulla. Enim eu
                                turpis egestas pretium aenean pharetra magna.
                                Aliquam id diam maecenas ultricies mi eget us
                                mauris vitae ultricies leo integer t malesuada
                            ...
                            <div className='text-sm mb-10'>
                              <div className='space-y-2'>
                                <p>
                                  ...
                                  mattis pellentesque lacus suspendisse faucibus
                                  interdum.
                                </p>
                              </div>
                            </div>
                      ...
                      <ModalAction
                        ...
                        <div className='text-center'>
                          ...
                          <div className='text-xs text-slate-500 italic mt-3'>
                            I respect your privacy. No spam. Unsubscribe at any
                            time!
                          </div>
                        </div>
                      </ModalAction>
                      ...
                      <ModalAction
                        ...
                        <div className='text-sm mb-5'>
                          ...
                          <div className='text-xs text-slate-500'>
                            ...
                            . You can stop it at any time on the integrations
                            page of your Mosaic account.
                          </div>
                        </div>
                        {/* Modal footer */}
                        <div className='flex flex-wrap justify-end space-x-2'>
                      ...
                      <ModalBlank
                        ...
                        <div className='p-5'>
                          ...
                          <div className='text-sm mb-5'>
                            <div className='space-y-2'>
                              <p>
                                You might not be aware of this fact, but every
                                frame, digital video, canvas, responsive design,
                                and image often has a rectangular shape that is
                                exceptionally precise in proportion (or ratio).
                              </p>
                              <p>
                                The ratio has to be well-defined to make shapes
                                fit into different and distinct mediums, such as
                      ...
                      <ModalBasic
                        ...
                        <div className='px-5 pt-4 pb-1'>
                          <div className='text-sm'>
                                ...
                                <button className='w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-indigo-400 shadow-sm duration-150 ease-in-out'>
                                  <div className='flex items-center'>
                                    ...
                                    <div className='grow'>
                                      ...
                                      <div className='text-sm'>
                                        2 MB · 1 member · 500 block limits
                                      </div>
                                    </div>
                                  </div>
                                </button>
                                    ...
                                    <div className='grow'>
                                      <div className='flex flex-wrap items-center justify-between mb-0.5'>
                                        <span className='font-semibold text-slate-800'>
                                          Mosaic Basic{' '}
                                          <span className='text-xs italic text-primary align-top'>
                                            Best Value ✨
                                          </span>
                                        </span>
                                        <span>
                                      ...
                                      <div className='text-sm'>
                                        5 MB · 2 members · 1000 block limits
                                      </div>
                                    </div>
                                  </div>
                                </button>
                                ...
                                <button className='w-full h-full text-left py-3 px-4 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out'>
                                  <div className='flex items-center'>
                                    ...
                                    <div className='grow'>
                                      ...
                                      <div className='text-sm'>
                                        10 MB · 5 members · Unlimited block
                                        limits
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div className='text-xs text-slate-500'>
                              Your workspace’s Mosaic Light Plan is set to $39
                              per month and will renew on August 9, 2021.
                            </div>
                          </div>
                        </div>
                        {/* Modal footer */}
