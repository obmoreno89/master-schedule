...
export const getKpiNumberOfOrders = () => (dispatch) => {
  axios
    .get('http://35.174.106.95/api/kpis/orders-in-past-due')
    .then((response) => {
...
export const getKpiAmountOfOrders = () => (dispatch) => {
  axios
    .get('http://35.174.106.95/api/kpis/total-amount-orders-in-past-due')
    .then((response) => {
      if (response.status === 200) {
...
export const getOrdersProgrammed = () => (dispatch) => {
  axios
    .get('http://35.174.106.95/api/kpis/orders-without-ship-date')
    .then((response) => {
      if (response.status === 200) {
...
export const getExcessInventory = () => (dispatch) => {
  axios
    .get('http://35.174.106.95/api/kpis/excess-inventory')
    .then((response) => {
      if (response.status === 200) {
