...
import CapabilitiesCustomEdit from "./CapabilitiesCustomEdit";
import { useDispatch } from "react-redux";
import { revertEdit } from "../../store/slice/capabilitiesCustomSlice";

function CapabilitiesCustomEditPanel({
  ...
  useEffect(() => {
    const keyHandler = ({ keyCode }) => {
      if (!capabilitiesCustomEditOpenPanel || keyCode !== 27) return;
      setCapabilitiesCustomEditOpenPanel(false);
    };
  ...
  return (
    <>
      <Transition
        ...
        show={capabilitiesCustomEditOpenPanel}
...
export default CapabilitiesCustomEditPanel;
