...
import CapabilitiesCustomCreate from './CapabilitiesCustomCreate';

function CapabilitiesCustomCreatePanel({
  ...
  useEffect(() => {
    const keyHandler = ({ keyCode }) => {
      if (!capabilitiesCustomCreateOpenPanel || keyCode !== 27) return;
      setCapabilitiesCustomCreateOpenPanel(false);
    };
  ...
  return (
    <>
      <Transition
        ...
        show={capabilitiesCustomCreateOpenPanel}
        ...
        >
          <div className='top-16 bg-white overflow-x-hidden overflow-y-auto no-scrollbar shrink-0 border-l border-slate-200 w-full sm:w-[390px] h-screen'>
            <div className='flex justify-between'>
              ...
              <button
                ref={closeBtn}
                onClick={() => setCapabilitiesCustomCreateOpenPanel(false)}
...
export default CapabilitiesCustomCreatePanel;
